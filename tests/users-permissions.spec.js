...
test.describe('権限設定・グループ権限', () => {
    ...
    test('3-7: マスターユーザーで電話番号を変更できること', async ({ page }) => {
        ...
        expect(page.url()).toContain('/admin/admin/edit/');
        // フォーム要素が存在すること
        await expect(page.locator('form, input, button.btn-ladda').first()).toBeVisible({ timeout: 30000 });
    ...
    test('3-17: マスターユーザーで通知先メールアドレスを変更できること', async ({ page }) => {
        ...
        expect(page.url()).toContain('/admin/admin/edit/');
        // フォーム要素が存在すること
        await expect(page.locator('form input, form button').first()).toBeVisible({ timeout: 30000 });
...
test.describe('権限設定の動作確認（テストユーザー作成・権限付与・ログイン確認）', () => {
    ...
    test('61-3: デバッグAPIで作成したテストユーザーでログインできること', async ({ browser }) => {
        ...
        try {
            ...
            await testPage.waitForSelector('.navbar', { timeout: 30000 }).catch(() => {});
    ...
    // -------------------------------------------------------------------------
    test('351: ユーザー管理画面のログイン状態表示が正常に動作すること', async ({ page }) => {
        // ユーザー管理画面へ
    ...
    // -------------------------------------------------------------------------
    test('360: ユーザーテーブルのデフォルト項目が編集不可であること', async ({ page }) => {
        await page.goto(BASE_URL + '/admin/admin', { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('450: ユーザーの組織設定で兼務登録がエラーなく行えること', async ({ page }) => {
        await page.goto(BASE_URL + '/admin/admin', { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('515: マスターユーザーがCSV UP/DL履歴ページにアクセスできること', async ({ page }) => {
    ...
    // -------------------------------------------------------------------------
    test('627: ユーザー管理画面のテーブル一覧に役職列が存在すること', async ({ page }) => {
        await page.goto(BASE_URL + '/admin/admin', { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('692: 権限設定にログ関連の権限項目が存在すること', async ({ page }) => {
        // 権限設定画面へ（グループ権限ページ）
    ...
    // -------------------------------------------------------------------------
    test('768: ユーザー編集画面でパスワード欄にDUMMY PASSWORDが表示されないこと', async ({ page }) => {
        await page.goto(BASE_URL + '/admin/admin', { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('635: 編集権限ユーザーが複数値の他テーブル参照項目を編集可能であること', async ({ page }) => {
        // テーブル一覧へ（ALLテストテーブル）
        if (sharedTableId) {
    ...
    // -------------------------------------------------------------------------
    test('587: 2要素認証設定画面が存在すること', async ({ page }) => {
        // その他設定画面へ
    ...
    // -------------------------------------------------------------------------
    test('620: ログイン画面にパスワードリセットリンクが表示されること', async ({ browser }) => {
...
test.describe('バグ修正・機能改善確認（UP08）', () => {
    ...
    // -------------------------------------------------------------------------
    test('263: 複数の計算項目を連続使用しても各計算結果が正しく表示されること', async ({ page }) => {
        // テーブル設定で計算項目を確認
    ...
    // -------------------------------------------------------------------------
    test('277: 一般ユーザーでユーザー情報の閲覧権限がない場合メニューに表示されないこと', async ({ page }) => {
        // テストユーザー作成
    ...
    // -------------------------------------------------------------------------
    test('304: 権限設定の編集不可項目が一覧画面で非表示にならず表示されること', async ({ page }) => {
        // テーブルの権限設定ページを確認
        await page.goto(BASE_URL + `/admin/dataset__${tableId}/setting`, { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('305: テーブル一覧で縦スクロール時に横スクロールバーが消えないこと', async ({ page }) => {
        await page.goto(BASE_URL + `/admin/dataset__${tableId}`, { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('311: 権限設定の編集不可項目が正しく制御されること', async ({ page }) => {
        // テーブル設定の権限設定を開く
        await page.goto(BASE_URL + `/admin/dataset__${tableId}/setting`, { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('329: グループ追加画面でテーブル一括権限設定のデフォルトが「無し」であること', async ({ page }) => {
        // グループ管理ページ
        await page.goto(BASE_URL + '/admin/group', { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('331: 他テーブル参照の表示条件がテーブル保存前に変更されないこと', async ({ page }) => {
        // テーブル設定
        await page.goto(BASE_URL + `/admin/dataset__${tableId}/setting`, { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('338: ユーザータイプでログイン時に他テーブル参照の表示条件が正しく動作すること', async ({ page }) => {
    ...
    // -------------------------------------------------------------------------
    test('340: 複数権限グループのテーブル項目設定・管理者設定が競合しないこと', async ({ page }) => {
        await page.goto(BASE_URL + `/admin/dataset__${tableId}/setting`, { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('348: ユーザー管理テーブルの権限設定でカスタム項目が非表示項目に混在しないこと', async ({ page }) => {
        // ユーザー管理テーブルの設定ページ
        await page.goto(BASE_URL + '/admin/user', { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('364: ユーザー管理テーブルで他テーブル参照項目の作成がエラーにならないこと', async ({ page }) => {
        // ユーザー管理テーブルの設定ページ
    ...
    // -------------------------------------------------------------------------
    test('369: 数値項目の一覧表示で名前と単位が重複しないこと', async ({ page }) => {
        await page.goto(BASE_URL + `/admin/dataset__${tableId}`, { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
...
test.describe('バグ修正・機能改善確認（UP09）', () => {
    ...
    // -------------------------------------------------------------------------
    test('389: フォルダ権限設定でアクセス権のあるフォルダ内テーブル作成が可能であること', async ({ page }) => {
        // グループ権限設定ページを確認
        await page.goto(BASE_URL + '/admin/group', { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('392: ユーザーテーブルの他テーブル参照でルックアップが正常に機能すること', async ({ page }) => {
    ...
    // -------------------------------------------------------------------------
    test('405: テーブル権限変更時にログが記録されること', async ({ page }) => {
        // ログページを確認
    ...
    // -------------------------------------------------------------------------
    test('410: マスターユーザーがユーザー一覧からアカウントロック解除できること', async ({ page }) => {
        await page.goto(BASE_URL + '/admin/user', { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('416: ユーザータイプ「ユーザー」でも請求情報にアクセスできる権限設定が存在すること', async ({ page }) => {
        // グループ権限設定ページ
        await page.goto(BASE_URL + '/admin/group', { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('417: 親テーブルのレコード作成時に子テーブルのデフォルト表示数設定が機能すること', async ({ page }) => {
        // テーブル設定の詳細画面設定
        await page.goto(BASE_URL + `/admin/dataset__${tableId}/setting`, { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('432: 数値項目（小数形式）で小数点の入力が可能であること', async ({ page }) => {
        // レコード新規作成画面
    ...
    // -------------------------------------------------------------------------
    test('439: ルックアップにユーザーテーブル参照の複数項目を設定できること', async ({ page }) => {
        // テーブル設定の項目設定
        await page.goto(BASE_URL + `/admin/dataset__${tableId}/setting`, { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('449: 他テーブル参照の一覧用表示項目がカンマ区切りで正しく表示されること', async ({ page }) => {
        await page.goto(BASE_URL + `/admin/dataset__${tableId}`, { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('451: 項目権限設定の変更がログに記録されること', async ({ page }) => {
        await page.goto(BASE_URL + '/admin/logs', { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('454: 公開フォームからデータ送信後に閲覧権限エラーが発生しないこと', async ({ page }) => {
    ...
    // -------------------------------------------------------------------------
    test('477: ユーザー管理テーブルの値重複禁止設定が削除後に正しくリセットされること', async ({ page }) => {
        // ユーザー管理テーブルの設定
        await page.goto(BASE_URL + '/admin/user/setting', { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('492: 権限設定の非表示項目が子テーブルの詳細画面でも正しく非表示になること', async ({ page }) => {
        // テーブルの権限設定を確認
        await page.goto(BASE_URL + `/admin/dataset__${tableId}/setting`, { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('496: レコードの複製機能がエラーなく動作すること', async ({ page }) => {
        // レコード一覧
        await page.goto(BASE_URL + `/admin/dataset__${tableId}`, { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('514: 他テーブル参照項目のレコード詳細画面が正常に表示されること', async ({ page }) => {
        // レコード詳細画面
...
test.describe('バグ修正・機能改善確認（UP10）', () => {
    ...
    // -------------------------------------------------------------------------
    test('536: ルックアップに他テーブル参照の複数項目を設定してもエラーが出ないこと', async ({ page }) => {
        await page.goto(BASE_URL + `/admin/dataset__${tableId}/setting`, { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('559: 権限グループのユーザー追加が送信ボタンだけで即反映されないこと', async ({ page }) => {
        await page.goto(BASE_URL + `/admin/dataset__${tableId}/setting`, { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('590: ユーザーテーブルの他テーブル参照ルックアップが正常動作すること', async ({ page }) => {
        await page.goto(BASE_URL + '/admin/user', { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
    ...
    // -------------------------------------------------------------------------
    test('630: マスターユーザーでログインしてユーザー管理画面が表示されること', async ({ page }) => {
    ...
    // -------------------------------------------------------------------------
    test('251: ユーザー管理テーブルでログイン状態のソートが正常に動作すること', async ({ page }) => {
        await page.goto(BASE_URL + '/admin/user', { waitUntil: 'domcontentloaded', timeout: 30000 }).catch(() => {});
        await waitForAngular(page);
